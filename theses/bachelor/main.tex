...
In general, several partonic channels contribute to each process. In the following discussion, however, we will focus on one representative channel for each case. Our goal is not to reproduce the full results, but rather to highlight the main features of the NSC subtraction scheme as presented in the cited works.
\\
